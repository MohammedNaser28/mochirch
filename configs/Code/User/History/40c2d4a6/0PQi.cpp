...
vote guaranteed. Ducks City has poles.
The cost of putting one poster on a pole equals . is the
height of the pole and is the number of posters already on the pole.
Amin knows that he needs votes to win the elections.
...
Input
The first line of each test has one integer The
number of test cases.
The first line of each testcase has three integers , , and
The number of poles in Ducks City, the
required number of votes, and the integer .
The second line of each testcase has integers
The height of the light poles.
The summation of and over all testcases doesn't exceed .
Output
